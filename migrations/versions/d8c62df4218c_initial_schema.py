...
def upgrade() -> None:
    ...
    op.create_table('mealingredient',
    ...
    sa.ForeignKeyConstraint(['meal_id'], ['meal.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('week_start_date', 'day_of_week', name='uq_weeklyplan_week_day')
    )
    op.create_index(op.f('ix_weeklyplan_day_of_week'), 'weeklyplan', ['day_of_week'], unique=False)
    op.create_index(op.f('ix_weeklyplan_week_start_date'), 'weeklyplan', ['week_start_date'], unique=False)
